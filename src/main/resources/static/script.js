...
function getAvailableTrendIntervalOptions() {
    let hoursInUnit = {
        'HOUR': 1,
        'DAY': 24,
        'MONTH': 24 * 30,
...
function getAvailableBarIntervalOptions() {
    let hoursInUnit = {
        'QUARTER': 24 * 90,
        'MONTH': 24 * 30,
        'DAY': 24,
...
class ChatActivityBarChart {
    constructor(containerElementId, chartElementId) {
        ...
        this.refreshChartData = function() {
            let path = window.location.pathname + "/activity-bar-chart";
            let param = $.param({
                from: getFromDate(),
                to: getToDate(),
        ...
        this.init = function() {
            ...
            this.intervalOptions = getAvailableBarIntervalOptions();
...
class ChatActivityTrendChart {
    constructor(containerElementId, chartElementId) {
        ...
        this.refreshChartData = function() {
            let path = window.location.pathname + "/activity-trend-chart";
            let param = $.param({
                from: getFromDate(),
                to: getToDate(),
                attribute: this.getAttribute(),
        ...
        this.init = function() {
            ...
            this.intervalOptions = getAvailableTrendIntervalOptions();
            this.renderIntervalOptions();
            let path = window.location.pathname + "/activity-trend-chart";
            let param = $.param({
                from: getFromDate(),
